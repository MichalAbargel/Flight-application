...
namespace flightModel
{
    ...
    {
        //flightInfo myDeserializedClass = JsonConvert.DeserializeObject<flightInfo>(myJsonResponse);
        ...
        public class Airline
        {
            ...
            public string info
            {
                get
                {
                    return "Airline: " + this.name + "  Code:" + code.icao;
                }
            }
        }
        ...
        public class Destination
        {
            ...
            public string name
            {
                get
                {
                    this.name = this._name.Replace(" ", "\n");
                    return string.Format(this._name);
                }
                set
                {
                    this._name = value;
        ...
        public class Estimated
        {
            ...
            public TimeSpan t_departure { 
                get
                {
                    return EpochToDateTime.GetDateTimeFromeEpoch(this.departure).TimeOfDay;
                }
            }
            public int arrival { get; set; }
            public TimeSpan t_arrival
            {
                get
                {
                    return EpochToDateTime.GetDateTimeFromeEpoch(this.arrival).TimeOfDay;
                }
            }
        ...
        public class Position
        {
            ...
            public string place {
                get
                {
                    return this.country.name + " - " + this.region.city;
                } 
            }
        }
        ...
        public class Real
        {
            ...
            public DateTime t_departure
            {
                get
                {
                    return EpochToDateTime.GetDateTimeFromeEpoch(this.departure);
                }
            }
            public int arrival { get; set; }
            public DateTime t_arrival
            {
                get
                {
                    return EpochToDateTime.GetDateTimeFromeEpoch(this.arrival);
                }
            }
        }
